		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			...
			<div class="menu">
						<div class="social">
							...
							<?php if ($user->ID == 0): ?>
								<a href = "<?php echo bloginfo('url'); ?>/index.php/login">Se connecter </a>
								<a href = "<?php echo bloginfo('url'); ?>/index.php/register">S'inscrire</a>
							<?php else: ?>
								Salut <?php echo $user->user_login; ?>
								<a href = "<?php echo bloginfo('url'); ?>/index.php/profil">Mon profil</a>
								<a href = "<?php echo bloginfo('url'); ?>/index.php/logout">Se déconnecter</a>
							<?php endif ?>
						</div>
					</div>
		</nav><!-- #site-navigation -->
